...
## Project Scope
This is a personal project to learn Go Programming while exploring Linux Persistence Mechanisms that I find interesting. NixPersist provides a simple CLI to quickly install and remove any of the currently supported persistence mechanisms for rapid Blue Team testing / Detection Engineering.
